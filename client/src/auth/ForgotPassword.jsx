            ...
            <div className="mt-5">
              <form onSubmit={(e) => handleSubmit(e)}>
                <div className="grid gap-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="block w-full px-4 py-3 text-sm border-2 border-gray-200 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500"
                        required
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-white transition-all bg-green-500 border border-transparent rounded-md hover:bg-green-400 hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                  >
                    Reset password
                  </button>
                </div>
